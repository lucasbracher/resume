...
\textit{Outros} - AWS (Lambda, Rekognition, SageMaker), LLMs (AzureAI, OpenAI), ElasticSearch, pdflatex, LaTeX, OpenCV, Scrapy, Bash, Docker, RabbitMQ, Celery, git, .NET Compact\\
}
