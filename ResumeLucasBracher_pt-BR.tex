...
\title{Lucas Bracher -- Currículo} % Cabeçalho principal
...
\tabbedblock{
	\bf{2001-2008} \> Engenharia da Computação - \href{https://ic.unicamp.br/graduacao/engenharia-da-computacao/}{Universidade Estadual de Campinas (Unicamp), Brasil} \\[2pt]
...
\textit{Linguagens de Programação} - Python, PHP, Golang, C, C++, C\#, JavaScript, Clojure, Golang, VBA, Delphi\\
...
\textit{Outros} - AWS (Lambda, Rekognition, SageMaker, API Gateway, S3, RDS), LLMs (AzureAI, OpenAI), ElasticSearch, pdflatex, LaTeX, OpenCV, Scrapy, Bash, Docker, RabbitMQ, Celery, git, .NET Compact\\
}
